...
Object.assign(arText, {
  ...
  "We help customers choose the right chemistry, additives, lacquers, machines, and accessories based on their application, substrate, finish requirements, and production conditions.":
    "نساعد العملاء على اختيار كيماويات الطلاء والإضافات واللاكيهات والماكينات والإكسسوارات المناسبة حسب التطبيق ونوع الخامة ومتطلبات التشطيب وظروف الإنتاج.",
  ...
  "El Etehadia supplies a wide range of products for industrial surface finishing, including chemistry, additives, lacquers, machines, accessories, and supporting materials.": "توفر الاتحادية مجموعة واسعة من منتجات معالجة وتشطيب الأسطح الصناعية، تشمل كيماويات الطلاء والإضافات واللاكيهات والماكينات والإكسسوارات والمواد المساعدة.",
  ...
  "Technical support": "دعم فني",
  "Electroplating chemicals, machines, accessories, lacquers, laboratory analysis, and technical support.": "كيماويات الطلاء الكهربائي، والماكينات، والإكسسوارات، واللاكيهات، وخدمات التحليل المعملي والدعم الفني.",
  "Contact us": "تواصل معنا",
...
const arAttributes = {
  ...
  "HAWKING England — lacquers and protective finishing brand": "لاكيهات وتشطيبات واقية من HAWKING England",
