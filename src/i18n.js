  ...
  ar: {
    ...
    pages: {
      ...
      solutions: [
        ...
        "استعرض حلول تشطيب الأسطح: تجهيز السطح ومكافحة التآكل وفلزات الخفيفة والطلاءات الزخرفية والطلاء على البلاستيك والنيكل الكيميائي ومقاومة البلى والمعادن النفيسة وإعادة تدوير البلاستيك وWaterCARE.",
      ],
    },
  },
};
...
Object.assign(arText, {
  ...
  "El Etehadia Company for Import, Export & Agencies has supported manufacturers from Cairo since 1997. The company supplies electroplating chemicals, machines, accessories, lacquers, and technical services for industrial surface-finishing operations across Egypt and the Middle East.":
    "تقوم الشركة الاتحادية للاستيراد والتصدير والتوكيلات بالدعم للمصنعين في القاهرة وجميع محافظات جمهورية مصر العربية منذ عام 1997. توفر الشركة كيماويات وماكينات وإكسسوارات ولاكيهات الطلاء الكهربائي وخدمات فنية لعمليات معالجة الأسطح الصناعية في مصر والشرق الأوسط.",
  ...
  "Aerospace and defense": "الطيران والفضاء والدفاع",
  "High-reliability finishing, corrosion control, and process support for aerospace, defense, and critical hardware where conformance matters.":
    "تشطيب عالٍ الموثوقية ومكافحة التآكل ودعم العمليات لمكونات الطيران والفضاء والدفاع والعتاد الحرجة حيث يهم الامتثال.",
  ...
  "Decorative metallization and finishing for trims, closures, hardware accents, and metallic packaging details.":
    "معدنة وتشطيب ديكوري للحواف والإغلاق وتفاصيل المشغلات والتغليف المعدنية.",
  ...
  "Corrosion-resistant plating for valves, fasteners, connectors, and hardware used in harsh chemical exposure and demanding field service.":
    "طلاء مقاوم للتآكل للصمامات والمثبتات والوصلات والمشغلات المستخدمة في التعرّض الكيميائي الشديد وبيئات التشغيل الصعبة.",
  ...
  "Metallization and plating support for engineered plastic components, including applications that use recycled or reprocessed molding feedstock.":
    "دعم معدنة وتطعيم لمكونات بلاستيكية هندسية، بما في ذلك التطبيقات التي تستخدم مادة خام معاد تهيئتها من إعادة التدوير أو إعادة المعالجة.",
  "Plumbing and sanitary fittings": "السباكة والتركيبات الصحية",
  ...
  "Protective finishes and corrosion control for fasteners, busbars, enclosures, and hardware used across solar, wind, and broader energy infrastructure.":
    "تشطيبات واقية ومكافحة تآكل للمثبتات والقواطع الكهربائية والمحاويات والمشغلات المستخدمة في الطاقة الشمسية والرياح وبنية الطاقة بشكل أوسع.",
  ...
  "See featured products": "اعرف المنتجات البارزة",
  "All Solutions": "جميع الحلول",
  "Featured product families": "عائلات منتجات بارزة",
  "Browse families by solution": "تصفّح العائلات بحسب نوع الحل",
  "Surface finishing portfolio": "محفظة تشطيب الأسطح",
  "Surface finishing solutions for demanding industries": "حلول تشطيب أسطح لمقتضيات الصناعات المتطورة.",
  "Related solutions": "حلول ذات صلة",
  "Product examples": "أمثلة منتجات",
  "Portfolio overview.": "نظرة عامة على المحفظة.",
  "Need help selecting the right surface finishing solution?": "تحتاج مساعدة لاختيار حل تشطيب السطح المناسب؟",
  "Connect with our team to identify the right chemistry, process, and finish for your application.": "تواصل مع فريقنا لتحديد الكيمياء والعملية والتشطيب المناسبين لتطبيقك.",
  "Contact Us": "تواصل معنا",
  "Solution not found.": "الحل غير موجود.",
  "Back to Solutions": "العودة إلى الحلول",
  "Delivering innovative solutions designed to meet the evolving demands of the dynamic surface finishing industry and ever-changing customer requirements.": "حلول مبتكرة لتلبية متطلبات صناعة تشطيب الأسطح الديناميكية واحتياجات العملاء المتغيرة.",
...
const arAttributes = {
  ...
  "El Etehadia branded logistics and electroplating supply across Egypt": "الاتحادية للوجستيات وتوريد الطلاء الكهربائي في أنحاء مصر",
  ...
  "Silver-plated electrical contacts and functional electroless nickel finishes": "جهات اتصال كهربائية مطلية بالفضة وتشطيبات نيكل كهربائي لامع وظيفية",
  "MacDermid Enthone Industrial Solutions — plating chemistry and surface finishing brand": "ماكديرميد إنثوني للحلول الصناعية — علامة كيمياء الطلاء وتشطيب الأسطح",
  "HAWKING England — lacquers and protective finishing brand": "هوكينج إنجلترا — اللاكرات والعلامة التجارية للتشطيب الواقي",
