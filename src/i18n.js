...
const pageMeta = {
  en: {
    ...
    pages: {
      ...
      macdermidEnthoneEgypt: ["MacDermid Enthone Egypt | Official Distributor | El Etehadia", "El Etehadia is the sole MacDermid Enthone distributor in Egypt, supplying surface-finishing chemistry with local technical and laboratory support."],
  ...
  ar: {
    ...
    pages: {
      ...
      macdermidEnthoneEgypt: ["MacDermid Enthone مصر | الموزع الرسمي | الاتحادية", "الاتحادية هي الموزع الوحيد لـ MacDermid Enthone في مصر، وتوفر كيمياء تشطيب الأسطح مع الدعم الفني والخدمات المعملية المحلية."],
...
Object.assign(arText, {
  ...
  "MacDermid Enthone Egypt": "MacDermid Enthone مصر",
  "MacDermid Enthone Distributor in Egypt": "موزع MacDermid Enthone في مصر",
  "El Etehadia is the sole distributor of MacDermid Enthone Industrial Solutions in Egypt, supplying MacDermid Enthone surface-finishing chemistry together with local technical support and laboratory services.":
    "الاتحادية هي الموزع الوحيد لحلول MacDermid Enthone الصناعية في مصر، وتوفر كيمياء MacDermid Enthone لتشطيب الأسطح مع الدعم الفني المحلي والخدمات المعملية.",
  "Sole local distributor": "الموزع المحلي الوحيد",
  "Technical and application support": "دعم فني ودعم للتطبيقات",
  "Bath analysis and process guidance": "تحليل الأحواض وإرشاد العمليات",
  "Official distribution in Egypt": "التوزيع الرسمي في مصر",
  "Global surface-finishing technology with a local technical route.": "تقنية عالمية لتشطيب الأسطح عبر مسار فني محلي.",
  "Manufacturers in Egypt can work through El Etehadia for MacDermid Enthone product enquiries, chemistry supply, technical documents, application guidance, laboratory analysis, and production troubleshooting. The relationship connects an internationally recognized surface-finishing portfolio with local knowledge of Egyptian plating lines and manufacturing requirements.":
    "يمكن للمصنعين في مصر التعامل مع الاتحادية في استفسارات منتجات MacDermid Enthone وتوريد الكيميائيات والوثائق الفنية وإرشاد التطبيقات والتحليل المعملي وتشخيص مشكلات الإنتاج. وتربط هذه العلاقة مجموعة عالمية معروفة لتشطيب الأسطح بالخبرة المحلية في خطوط الطلاء ومتطلبات التصنيع المصرية.",
  "Surface-finishing portfolio": "مجموعة تشطيب الأسطح",
  "MacDermid Enthone chemistry for complete finishing processes.": "كيمياء MacDermid Enthone لعمليات التشطيب المتكاملة.",
  "Decorative and functional plating": "الطلاء الديكوري والوظيفي",
  "Chemistry and process support for copper, nickel, chrome, electroless nickel, plating on plastics, and wear-resistant finishes.": "كيمياء ودعم عمليات للنحاس والنيكل والكروم والنيكل الكيميائي والطلاء على البلاستيك والتشطيبات المقاومة للبري.",
  "Preparation and corrosion protection": "التجهيز والحماية من التآكل",
  "Surface conditioning, light-metal treatment, zinc and zinc-alloy systems, passivates, sealers, and conversion coatings.": "تجهيز الأسطح ومعالجة المعادن الخفيفة وأنظمة الزنك وسبائك الزنك والتخميل ومواد الإحكام وطلاءات التحويل.",
  "Process and wastewater support": "دعم العمليات ومياه الصرف",
  "Chemistry selection, bath control, troubleshooting, laboratory analysis, and WaterCARE routes for stable production.": "اختيار الكيميائيات وضبط الأحواض وتشخيص المشكلات والتحليل المعملي ومسارات WaterCARE لاستقرار الإنتاج.",
  "Local support": "الدعم المحلي",
  "From product enquiry to production follow-up.": "من استفسار المنتج إلى متابعة الإنتاج.",
  "Define the application": "تحديد التطبيق",
  "Share the substrate, process stage, required finish, specification, bath volume, and production conditions.": "شارك نوع الخام ومرحلة العملية والتشطيب المطلوب والمواصفة وحجم الحوض وظروف الإنتاج.",
  "Select the relevant chemistry": "اختيار الكيمياء المناسبة",
  "El Etehadia connects the requirement with the appropriate MacDermid Enthone product family and available technical documentation.": "تربط الاتحادية المتطلبات بعائلة منتجات MacDermid Enthone المناسبة والوثائق الفنية المتاحة.",
  "Support the operating line": "دعم خط التشغيل",
  "Local technical and laboratory services help teams review bath condition, defects, process stability, and corrective actions.": "تساعد الخدمات الفنية والمعملية المحلية الفرق على مراجعة حالة الأحواض والعيوب واستقرار العملية والإجراءات التصحيحية.",
  "Why work through El Etehadia": "لماذا تتعامل عبر الاتحادية",
  "One local connection for product, process, and support.": "جهة محلية واحدة للمنتج والعملية والدعم.",
  "Sole MacDermid Enthone distributor in Egypt": "الموزع الوحيد لـ MacDermid Enthone في مصر",
  "Local chemistry supply": "توريد محلي للكيميائيات",
  "Technical troubleshooting": "تشخيص فني للمشكلات",
  "Application-led product selection": "اختيار منتجات مبني على التطبيق",
  "Product, distribution, and technical-service guidance for Egypt.": "إرشاد للمنتجات والتوزيع والخدمات الفنية في مصر.",
  "Discuss a MacDermid Enthone requirement": "ناقش متطلبات MacDermid Enthone",
