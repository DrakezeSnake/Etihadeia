...
(function () {
  ...
  var pageCopy = {
    ...
    ar: {
      ...
      metaDescription:
        "تورد الاتحادية كيماويات الطلاء الكهربائي وماكينات الطلاء واللاكيهات والتحليل المعملي والدعم الفني.",
      ...
      heroTitle: ["الاتحادية"],
      heroIntro:
        "توفر الاتحادية كيماويات الطلاء الكهربائي، والماكينات، والإكسسوارات، واللاكيهات، وخدمات التحليل المعملي والدعم الفني للمصنعين في مصر والشرق الأوسط.",
      ...
      aboutCta: "من نحن",
      aboutLine:
        "تدعم الشركة الاتحادية للاستيراد والتصدير والتوكيلات المصنّعين منذ عام 1997 من خلال توفير كيماويات الطلاء الكهربائي، والماكينات، والإكسسوارات، واللاكيهات، والخدمات الفنية لعمليات معالجة وتشطيب الأسطح الصناعية في مصر والشرق الأوسط.",
      whyLabel: "لماذا نحن",
      ...
      serviceCards: [
        ...
        ["اختيار المنتجات", "مساعدة في اختيار كيماويات الطلاء، والإضافات، واللاكيهات، والماكينات، والإكسسوارات وفقاً للتشطيب المطلوب ونوع الخامة."],
      ...
      customersIntro:
        "فئات أساسية تشمل النيكل، والكروم، والنحاس، والزنك، والطلاء على البلاستيك، وتجهيز الأسطح، واللاكيهات، والأملاح، والألوان، والإضافات.",
      ...
      footerTag:
        "كيماويات الطلاء الكهربائي، والماكينات، والإكسسوارات، واللاكيهات، وخدمات التحليل المعملي والدعم الفني.",
