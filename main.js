...
(function () {
  ...
  var pageCopy = {
    ...
    ar: {
      ...
      aboutCta: "من نحن",
      aboutLine:
        "تقوم الشركة الاتحادية للاستيراد والتصدير والتوكيلات بالدعم للمصنعين في القاهرة وجميع محافظات جمهورية مصر العربية منذ عام 1997 بكيماويات وماكينات وإكسسوارات ولاكيهات الطلاء الكهربائي وخدمات فنية لعمليات معالجة الأسطح الصناعية في مصر والشرق الأوسط.",
      whyLabel: "لماذا نحن",
